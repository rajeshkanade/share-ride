...
function MapView() {
  return (
    <section className="flex flex-col items-end px-16 pt-6 mx-auto w-full text-sm font-medium text-green-600 bg-neutral-200 h-full max-md:px-5 max-md:pb-24 max-md:max-w-full h-full">
