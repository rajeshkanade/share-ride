...
router.post("/register", [
    ...
    body("vehicle.model").isLength({min: 3}).withMessage("Model must be at least 3 character long"),
    body("vehicle.capacity").isInt({min: 1}).withMessage("Capacity must be at least 1"),
    body("vehicle.type").isIn(["car", "motorcycle", "auto", "van"]).withMessage("Invalid vehicle type"),
